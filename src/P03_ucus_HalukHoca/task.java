...
public class task {
        ...
        4- todo bilet yazdırırken Flight No ve Gate Number dinamik olarak oluşturulmuştur.
            todo flight no oluşturma şekli: bulduğumuz seneyi alıyor 2022 + bulunduumuz saati alıyor concat edip yazdırıyor .
            todo Gate number oluşturma şekli:  gidilecek şehir ismi + mathrandom(10)
            */
        /*
